...
public class Enhancer extends JFrame implements ActionListener , ItemListener , ChangeListener ,MouseMotionListener,MouseListener{
    ...
    int rectfx=0;
    int rectfy=0;
    double  imagescaleratio=100.100;
...
//    BufferedImage bufferimage2 = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
   ...
   // Graphics2D  gracrop= bufferimagedisplay.createGraphics();
    ...
    public Enhancer() {
       ...
       // adjust.addSeparator();
        ...
        JMenu swapcolor = new JMenu("Swap Colours");
        ...
        image.add(adjust);
        image.addSeparator();
       JMenuItem show = new JMenuItem("Show Information");
        image.add(show);
       ...
       JMenuItem invert = new JMenuItem("Negative");
        ...
        image.addSeparator();
       JMenuItem black = new JMenuItem("Gray Scale");
        image.add(black);
        ...
        image.add(swapcolor);
        image.addSeparator();
       JMenuItem swapanycolor=new JMenuItem("Swap Any Colour");
      ...
      image.add(turnrgb);
       ...
       JMenuItem crop = new JMenuItem("Crop");
        ...
        image.addSeparator();
       JMenuItem colour = new JMenuItem("Level Slicing");
        image.add(colour);
       ...
       JMenuItem  median = new JMenuItem("Low Pass Filter");
        filters.add(median);
        median.addActionListener(this);
        filters.addSeparator();
      
       JMenuItem minimum = new JMenuItem("Minimum Filter");
        filters.add(minimum);
        minimum.addActionListener(this);
        filters.addSeparator();
       JMenuItem maximum = new JMenuItem("Maximum Filter");
        filters.add(maximum);
        ...
        JMenu smooth=new JMenu("Smoothing");
       JMenuItem smoothnine = new JMenuItem("Smooth");
  ...
  /*     JMenuItem weightedsmoothnine = new JMenuItem("Weighted Smooth 9x9");
        ...
        smooth.addSeparator();
*/
       JMenuItem threshholdaveraging = new JMenuItem("Thresholding");
       ...
       JMenuItem sharpen = new JMenuItem("Sharpening");
        ...
        process.addSeparator();
       JMenuItem enhancecontrast=new JMenuItem("Contrast Stretching");
        enhancecontrast.addActionListener(this);
        process.add(enhancecontrast);
        process.addSeparator();
       JMenuItem equalizehistogram=new JMenuItem("Histogram Equalization");
       ...
       JMenuItem decrypt = new JMenuItem("Decrypt");
        ...
        JMenu analyze = new JMenu("Analysis");
   ...
   if(action=="Show Information"){
    ...
    if(action=="Negative"){invert();}//1
    if(action=="Gray Scale"){blackandwhite();}//2
    if(action=="Smooth"){smoothing();}//3
    if(action=="Weighted Smooth 9x9"){weightedsmoothing();}//4
    if(action=="Low Pass Filter"){filtermedian();}//5
    if(action=="Thresholding"){threshholdaveraging();}//6
    if(action=="Conservative"){conservative();}//7
    if(action=="Find Edges"){findedgessuperb();}//8
    if(action=="Sharpening"){sharpen2();}//9
    ...
    if(action=="Level Slicing"){colour();}//18
    ...
    if(action=="Minimum Filter"){minimumfilter();}
    if(action=="Maximum Filter"){maximumfilter();}
    ...
    if(action=="Histogram Equalization"){histogramequalisation();}
    if(action=="Contrast Stretching"){stretchcontrast.setVisible(true);dialogopen=true;}
...
public void mouseMoved(MouseEvent me){
    ...
    grahist.drawString("Minimum Filter : "+minintensity,100,335);
    grahist.drawString("Maximum Filter : "+maxintensity,100,350);
